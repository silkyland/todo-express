...
then
    ...
    # Directly export PATH for current session
    ...
    print_message "You are ready to go!"
fi
...
# Generate go.sum entries
print_message "Generating go.sum entries"
go mod tidy
